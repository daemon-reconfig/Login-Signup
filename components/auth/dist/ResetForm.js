...
exports.ResetForm = function () {
    ...
    var methods = react_hook_form_1.useForm({
        resolver: zod_1.zodResolver(schemas_1.ResetSchema),
        defaultValues: {
            email: ""
        }
    });
    ...
    return (React.createElement(card_wrapper_1.CardWrapper, { headerLabel: "Forgot your password?", backButtonLabel: "Back to Login", backButtonHref: "/auth/login", showSocial: false },
