...
exports.SignUpForm = function () {
    ...
    var methods = react_hook_form_1.useForm({
        resolver: zod_1.zodResolver(schemas_1.SignUpSchema),
        defaultValues: {
            email: "",
            password: ""
        }
    ...
    return (React.createElement(card_wrapper_1.CardWrapper, { headerLabel: "Create an account", backButtonLabel: "Already have an account? Login", backButtonHref: "/auth/login", showSocial: true },
        React.createElement(form_1.Form, __assign({}, methods),
            React.createElement("form", { onSubmit: methods.handleSubmit(onSubmit), className: "space-y-6" },
                    ...
                    React.createElement(form_1.FormField, { control: methods.control, name: "password", render: function (_a) {
                            ...
                            return (React.createElement(form_1.FormItem, null,
                                ...
                                React.createElement(form_1.FormControl, null,
                                    React.createElement(input_1.Input, __assign({}, field, { disabled: isPending, placeholder: "Your Name" }))),
                ...
                React.createElement(button_1.Button, { type: "submit", className: "w-full", disabled: isPending }, "Sign Up")))));
};
